...
library UniswapV2LiquidityMathLibrary {
    ...
    function computeProfitMaximizingTrade(
        ...
        internal
        pure
        returns (bool aToB, uint256 amountIn)
    {
    ...
    // gets the reserves after an arbitrage moves the price to the profit-maximizing ratio given an externally observed
    // true price
    ...
    // given two tokens, tokenA and tokenB, and their "true price", i.e. the observed ratio of value of token A to token
    // B,
